...
export default function Layout() {
  ...
  const { user, isLoading } = useUser();  // <-- fixed here
          ...
          <div className="right-section">
            ...
            >
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                >
                  {user?.user_metadata?.full_name || "Susan"}
                </p>
              </div>
              ...
              >
                <button
                  style={{ color: "#4f46e5", background: "transparent", border: "none" }}
                >
                  <svg
  ...
  return (
    <li>
      <Link
        className="navlink"
        to={to}
        style={{ display: "flex", alignItems: "center", gap: "10px", padding: "10px", color: "#4f46e5" }}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
